...
public class Ex12_PiDigits {
    ...
    public static void main(String[] args) {
        ...
        Map<Integer, Long> collected = p.calcPiDigits().limit(5000).collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));
        collected.entrySet().stream().forEach(entry -> System.out.println(entry.getKey() + " : " + entry.getValue()));
    }
}
